function source = source_reconstruction_angularerror(meg,srate,inv_meth,opm_space,noiseCov)
...
load(['Input/leadfield/2_ftLeadfield_order_66_ICBM_channels_' opm_space],'ftLeadfield')
load(['Input/leadfield/sim_opm_' opm_space],'D') % channel file
ftLeadfield.leadfield=(ftLeadfield.leadfield)';
