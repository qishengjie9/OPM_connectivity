...
%                      'tickLabelOffset', 'BarPlot: anchor group label below all bar labels');
                a = AutoAxis.AnchorInfo(hText, PositionType.Top, 'BarPlot_barLabels', PositionType.Bottom, ...
                     'tickLabelOffset', 'BarPlot: anchor group label all bar labels');                 
%                  a = AutoAxis.AnchorInfo(hText);'BarPlot: anchor bar label below axis'
         
                aa.addAnchor(a);
                
                %aa.addHandlesToCollection('BarPlot_groupLabels', hText); bar
