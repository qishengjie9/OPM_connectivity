function [] = run_all_epochs_angularerror()
...
net = 'DMN_samelead_nonoise_angularerror';
...
%                     load([file_alpha '/Subject_' num2str(s) '/theta0' '.mat']);
%                     load([file_xi '/Subject_' num2str(s) '/Axi' '.mat']);
                    % compute scalp meg
                    ...
                    est_data = source_reconstruction_angularerror(meg,srate,inv{iv},opm_space{m},noiseCov);
                    % bandpass filter
